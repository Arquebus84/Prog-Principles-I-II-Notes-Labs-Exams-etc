...
public class CompareStrings {
	public static void main(String[] args) {
		...
		System.out.println(s1.equals(s2) == s2.equals(s1)); //Displays true because they are the same object
		...
		//to right. For example, if s1 = "abc" and s2 = "abg", in s1.compareTo(s2) the first two characters 'a' & 'a' are compared. Becasue they are equal,
		...
		String abc = "abc";
		String abg = "abg";
		System.out.println(abc.compareTo(abg));
