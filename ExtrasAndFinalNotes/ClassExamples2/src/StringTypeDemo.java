...
public class StringTypeDemo {
	public static void main(String[] args) {
		...
		//Ex: String.length() obtains the total number of characters in a string message (starts at 0 as first character; includes the empty spaces and symbols)
		/* Method			:	Description
		...
		//The above message would give an error saying StringIndexOutOfBoundsException because the index number is not listed in the String
		
		System.out.println(message.charAt(message.length() - 1)); //This is returns the number of the last character of the string without an error
		...
		//Note: If you concatenate a string with a non-string (e.g. a number), that non-string is converted to a string and concatenated; for Example:
