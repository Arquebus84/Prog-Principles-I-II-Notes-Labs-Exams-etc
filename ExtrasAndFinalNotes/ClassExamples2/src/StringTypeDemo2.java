...
public class StringTypeDemo2 {
	public static void main(String[] args) {
		...
		//The next(), nextByte, nextShort(), nextInt(), nextLong(), nextFloat(), and nextDouble() are token-based inputs because the read individual elements
