...
public class StopWatch implements ActionListener{
	...
	Timer timer = new Timer(1000, new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
			//NOTE: If you wrote elapsedTime/1000, it gives the total elapsed seconds, not the current second itself (use % 60 after this)
	...
	public StopWatch() {
		...
		startButton.setBounds(150,200, 100, 50);	startButton.setFont(new Font("Times New Roman", Font.PLAIN, 12));
		//NOTE: You can use Lambda expression to create an anonymous inner class (Similar to JavaFX)
		/**
		...
		pauseButton.setBounds(250, 200, 100, 50);	pauseButton.setFont(new Font("Times New Roman", Font.PLAIN, 12));
		pauseButton.addActionListener(this);
		restartButton.setBounds(350,200, 100, 50);	restartButton.setFont(new Font("Times New Roman", Font.PLAIN, 12));
